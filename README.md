...
| `deltaweave-web` | Authenticated loopback HTTP management and embedded browser UI |
...
[PROTOCOL.md](docs/PROTOCOL.md). The separate local-only management HTTP API
and browser UI are described in [WEB_UI.md](docs/WEB_UI.md).
